...
class ProjectAgent:
    def __init__(self, default_model="llama3-8b-8192"):
        ...
        self.project_embeddings = self._load_embeddings()
    ...
    def _load_embeddings(self):
        path = Path(__file__).parent.parent / "data" / "project_embeddings.pt"
    ...
    def _encode_query(self, query):
        from sentence_transformers import SentenceTransformer  # загружается только при запросе
