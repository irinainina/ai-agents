...
class WelcomeAgent:
    ...
    def get_response(self, query, model=None, chat_history=None):
        ...
        system_prompt = (
            ...
            "Translate all content from English to the user's language when responding, except for terms.\n\n"
            ...
            "5. NEVER include words or phrases in languages other than the user's language (detected as {lang}), except for terms.\n\n"
